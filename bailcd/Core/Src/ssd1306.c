...
/* Gửi lệnh (Command) bằng Master_Transmit */
...
uint8_t ssd1306_Init(void) {
    /* Vòng lặp thay thế HAL_Delay để chờ OLED lên nguồn */
...
/* Đẩy toàn bộ điểm ảnh lên OLED bằng Master_Transmit */
void ssd1306_UpdateScreen(void) {
    uint8_t data_to_send[SSD1306_WIDTH + 1];
    data_to_send[0] = 0x40; // Byte báo hiệu đây là Data
